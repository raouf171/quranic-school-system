...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware('role:admin')
        ...
        // Halaqat (with custom parameter name)
    ...
    Route::middleware('role:teacher')
        ...
        // Halaqat du teacher
        Route::get('halaqat', [TeacherHalaqaController::class, 'index']);
        Route::get('halaqat/{halaqa}/students', [TeacherHalaqaController::class, 'students']);
        ...
        // Présence
        Route::get('seances/{seance}/attendance', [TeacherAttendanceController::class, 'index']);
        Route::post('seances/{seance}/attendance', [TeacherAttendanceController::class, 'store']);
    ...
    Route::middleware('role:parent')
        ...
        Route::get('children/{student}/memorizations', [ParentController::class, 'memorizations']);
        Route::get('children/{student}/revisions', [ParentController::class, 'revisions']);
        Route::get('children/{student}/payments', [ParentController::class, 'payments']);
        Route::get('children/{student}/ranking', [ParentController::class, 'ranking']);
